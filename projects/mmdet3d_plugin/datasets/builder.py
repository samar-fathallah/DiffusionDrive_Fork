    ...
    **kwargs
    ...
    if runner_type == 'IterBasedRunner':
        ...
        if hasattr(dataset, "datasets"):
            print(f"[DEBUG] Dataset has {len(dataset.datasets)} sub-datasets.")
        else:
            print("[DEBUG] Dataset has no 'datasets' attribute — single dataset mode.")
        print(f"[DEBUG] Dataset class name: {dataset.__class__.__name__}")
        try:
            print(f"[DEBUG] Dataset length: {len(dataset)} samples")
        except Exception as e:
            print(f"[DEBUG] Could not get dataset length: {e}")
